...
class BEM2D:
    ...
    def set_Mesh(self, Pts_e=[], Pts_t=[], Pts_s=[], h_edge=0.1, h_trace=0.1, Ne_edge=None, Ne_trace=None, Type='Quad', mode=0):
        ...
        Date: July. 2017
        """
        self.Mesh.set_Mesh(Pts_e,Pts_t,Pts_s,h_edge,h_trace,Ne_edge,Ne_trace,Type,mode)
